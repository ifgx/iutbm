...
from pygame.locals import * #FIXME : Why ?
import math
...
class Graphe(algo.Algo):
    ...
    def __init__(self,window):
        ...
        self.final = self.weight = 0 #FIXME : rename
        self.next = [] #same as above : next is a KEYWORD !
        self.selected = []
        ...
        self.end.rect.center=(self.center_x* 5 / 3,self.center_y * 5 / 3)#FIXME hardcode result of 5/3
...
class Sommet(object):
    ...
    def __init__(self, indice, name, x, y, image):
        ...
        self.name = name #FIXME name = indice ?
